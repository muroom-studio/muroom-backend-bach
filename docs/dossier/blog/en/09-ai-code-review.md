...
That template turned the AI from a novelty into a fixture. Nobody had to remember to invoke it or decide what to ask; review-by-default became the shape of a PR. Think of it as a linter that reads intent.

## What it actually caught

The short answer is that it caught real things, mostly early.
...
None of these were things we *couldn't* have caught. They were things two juniors moving fast *didn't* catch, at the exact moment catching them was cheapest. For a team with no senior reviewer, it wasn't a gimmick. It was the missing role, imperfectly filled.

## Where it decayed

Around the later stretch of the project we started skimming, then skipping, the reviews. Deadline pressure, plus a creeping sense that we'd "heard it all before." The reviewer kept flagging the same categories, and we kept being in a hurry.
...
2. **Make ignoring it expensive.** Not blocking (AI reviewers are wrong too often to gate merges), but a one-line "review dismissed because: ___" field in the PR template. The failure mode isn't bad advice; it's unread advice. Putting friction on the *dismissal* is the cheapest fix I can think of.
