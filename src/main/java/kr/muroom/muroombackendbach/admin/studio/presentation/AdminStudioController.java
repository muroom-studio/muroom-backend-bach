...
public class AdminStudioController {
  ...
  public ApiResponse<GeneratePresignedUrlsPutResponse> generateStudioImagePresignedUrls(
      @Validated @RequestBody StudioImagePresignedUrlRequest request) {
    GeneratePresignedUrlsPutResponse response = adminStudioService.generatePresignedPutUrls(request);
