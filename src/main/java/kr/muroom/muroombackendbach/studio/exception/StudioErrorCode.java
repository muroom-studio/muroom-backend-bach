...
public enum StudioErrorCode implements ErrorCode {
  ...
  THUMBNAIL_IMAGE_NOT_FOUND(HttpStatus.BAD_REQUEST, "ST-404-04", "썸네일 이미지를 찾을 수 없습니다."),
  BLUEPRINT_IMAGE_NOT_FOUND(HttpStatus.BAD_REQUEST, "ST-404-05", "설계도 이미지를 찾을 수 없습니다."),
  DRAFT_NOT_FOUND(HttpStatus.BAD_REQUEST, "SD-404-71", "해당 스튜디오 임시 저장본을 찾을 수 없습니다."),
  ;
