...
public enum StudioBoastErrorCode implements ErrorCode {
  ...
  STUDIO_BOAST_COMMENT_CANNOT_REPLY_TO_REPLY(HttpStatus.BAD_REQUEST, "SB-400-12", "작업실 소개(자랑)글의 대댓글에 대댓글을 달 수 없습니다."),
  STUDIO_BOAST_COMMENT_PARENT_MISMATCH(HttpStatus.BAD_REQUEST, "SB-400-13", "부모 댓글이 같은 작업실 소개(자랑)글에 속하지 않습니다."),
