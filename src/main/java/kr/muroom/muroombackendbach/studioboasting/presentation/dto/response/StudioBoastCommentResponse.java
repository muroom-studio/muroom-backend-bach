...
public record StudioBoastCommentResponse(
    ...
    @Schema(description = "댓글 수정일시", example = "2023-10-06T10:15:30Z")
    ...
    List<StudioBoastCommentResponse> replies,
  ...
  public static StudioBoastCommentResponse createSecretPlaceholder(Long commentId, List<StudioBoastCommentResponse> replies) {
  ...
  public static StudioBoastCommentResponse createDeletedPlaceholder(Long commentId, List<StudioBoastCommentResponse> replies) {
    return StudioBoastCommentResponse.builder()
        .id(commentId.toString())
        .content("삭제된 댓글입니다.")
        .isSecret(false)
