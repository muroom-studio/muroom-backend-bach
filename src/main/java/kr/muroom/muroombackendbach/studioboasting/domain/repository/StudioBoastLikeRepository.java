...
public interface StudioBoastLikeRepository extends JpaRepository<StudioBoastLike, Long> {
  ...
  Optional<StudioBoastLike> findByMusicianAndStudioBoast(Musician musician,
      StudioBoast studioBoast); // 객체로 조회

  boolean existsByMusicianAndStudioBoast(Musician musician, StudioBoast studioBoast); // 객체로 조회

  List<StudioBoastLike> findAllByMusicianAndStudioBoastIn(Musician musician,
      List<StudioBoast> studioBoasts); // 내가 좋아요한 게시글 목록 조회
