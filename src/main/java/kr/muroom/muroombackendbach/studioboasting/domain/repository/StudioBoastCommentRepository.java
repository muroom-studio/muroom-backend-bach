...
public interface StudioBoastCommentRepository extends JpaRepository<StudioBoastComment, Long>,
    StudioBoastCommentQueryRepository {

  // 최상위 댓글 목록을 '페이지네이션'하여 조회합니다.
  Page<StudioBoastComment> findByStudioBoastAndParentIsNull(StudioBoast studioBoast,
      Pageable pageable);
  ...
  boolean existsByCreatorUserId(Long musicianId);
}